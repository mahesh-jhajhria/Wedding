    ...
    <div className='bg-[url(https://img.freepik.com/premium-photo/indian-wedding-pooja_96696-144.jpg?semt=ais_hybrid)] h-[585px] w-full bg-cover  opacity-80 '>
        <div className='grid grid-cols-2 w-full h-[400px]   '>
           ...
           <div className='flex flex-col w-[430px]  ml-10 mt-11  '>
                 <form className='flex flex-col bg-rose-200 h-[480px] w-[470px] rounded-lg z-50 opacity-90 relative '>
                    <h1 className='font-semibold flex justify-center mt-[60px] '>Sign In</h1>
                    <p className='text-[12px] flex justify-center'>Let's plan your life time memory</p>
                    <label className='text-[14px] font-semibold ml-12 mt-[40px] flex '>E-mail or phone number</label>
                    <input type='email' placeholder='Email' className='w-[370px] h-[40px]   outline-none rounded-lg flex justify-center items-center ml-12 p-2  '/>

                    <label className='text-[14px] font-semibold ml-12 mt-[12px] flex '>Password</label>
                    <input type='password' placeholder='Password' className='w-[370px] h-[40px] outline-none  rounded-lg flex justify-center items-center ml-12  p-2 '/>
                    ...
                    <p className='text-red-600 flex justify-end mr-14 mt-1 text-[13px]'>Forget password ?</p>
                    ...
                    <p className='flex justify-center mt-2 text-[13px] font-semibold'>Don't have an account? <span className='text-red-900 ml-1 cursor-pointer' onClick={()=>navigate("/sigin")}>Sign up</span></p>
                 </form>
           </div>
        </div>
    </div>
